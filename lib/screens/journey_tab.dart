...
class JourneyTab extends ConsumerWidget {
  ...
  (String, String, Widget) _getBabySizeData(int week) {
    ...
    if (week <= 12) return ('PLUM', 'BABY IS THE SIZE OF A', const Icon(Icons.lens, size: 48, color: Colors.deepPurple));
    ...
    if (week <= 28) return ('EGGPLANT', 'BABY IS THE SIZE OF AN', const Icon(Icons.lens, size: 140, color: Colors.deepPurple));
